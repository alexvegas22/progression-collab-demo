<template>
  <div class="dropdown">
    <button class="btn btn-secondary dropdown-toggle" type="button" id="menu_historique" data-bs-toggle="dropdown"
            aria-expanded="false">
      {{ this.langage }}
    </button>
    <ul class="dropdown-menu" aria-labelledby="menu_historique">
      <li v-for="langage in this.langages" key="langage">
        ...
        <ul>
          <li>
            <button class="dropdown-item" @click="this.reinitialiserCodeEditeur(langage)" présentation_étape="4.1">
